  ...
  <div>
    ...
    <div class="product-list">
      ...
      <el-table :data="productList" stripe border  style="width: 100%">
        <el-table-column prop="name" label="Product Name" width="180" align="center" header-align="center"></el-table-column>
        <el-table-column prop="category" label="Category" width="120" align="center" header-align="center"></el-table-column>
        ...
        <el-table-column prop="material" label="Material" width="120" align="center" header-align="center"></el-table-column>
        <el-table-column prop="stockQuantity" label="Stock Quantity" width="120" align="center" header-align="center"></el-table-column>
